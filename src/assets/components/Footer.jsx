  ...
  return (
    <footer className={styles.footer}>
        <section className={styles.container}>
            <article className={styles.linksCont}>
                <img src={logo} alt="logo" />
                <span className={styles.links}>
                    <span>
                        <p className={`${styles.link} tp7r`}>FAQs</p>
                        <p className={`${styles.link} tp7r`}>Contact Us</p>
                    </span>
                    <span>
                        <p className={`${styles.link} tp7r`}>Private Policy</p>
                        <p className={`${styles.link} tp7r`}>Press Kit</p>
                    </span>
                    <span>
                        <p className={`${styles.link} tp7r`}>Install Guide</p>
                    </span>
                </span>
            </article>
