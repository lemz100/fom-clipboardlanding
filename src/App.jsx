...
import msLogo from '@/assets/images/logo-microsoft.png';
...
function App() {
  ...
  return (
    ...
    <picture>
      ...
      <img className='bg-img' src={mobileBg} alt='background header' />
    </picture>
    <section className='cta'>
      <img src={logo} alt="logo" />
      <article className="content">
        <span className="text-content">
          <p className="heading tp4">A history of everything you copy</p>
          <p className="desc tp8">Clipboard allows you to track and organize everything you copy. Instantly access your clipboard on all your devices.</p>
        </span>
    ...
    <section className="keep-track">
      <article className="desc-cont">
        <p className="heading tp5">Keep track of your snippets</p>
        <p className="desc tp8">Clipboard instantly stores any item you copy in the cloud, meaning you can access your snippets immediately on all your devices. Our Mac and iOS apps will help you organize everything.</p>
      </article>
      <article className="main-cont">
        <img className='computer-img' src={computerImg} alt="computer image" />
        <article className="features-cont">
          <span className="feature">
            <p className="title tp6">Quick Search</p>
            <p className="info tp8">Easily search your snippets by content, category, web address, application, and more.</p>
          </span>
          <span className="feature">
            <p className="title tp6">iCloud Sync</p>
            <p className="info tp8">Instantly saves and syncs snippets across all your devices.</p>
          </span>
          <span className="feature">
            <p className="title tp6">Complete History</p>
            <p className="info tp8">Retrieve any snippets from the first moment you started using the app.</p>
          </span>
        </article>
      </article>
    </section>
    <section className="access-clip">
      <article className="text-cont">
        <p className="heading tp5">Access Clipboard anywhere</p>
        <p className="info tp8">Whether you’re on the go, or at your computer, you can access all your Clipboard snippets in a few simple clicks.</p>
      </article>
      <img src={devicesImg} alt="devices" />
    </section>
    <section className="supercharge">
      <article className="desc-cont">
        <p className="heading tp5">Supercharge your workflow</p>
        <p className="info tp8">We’ve got the tools to boost your productivity.</p>
      </article>
      <article className="features-cont">
        <artice className="feature">
          ...
          <span className="desc">
            <p className="title tp6">Create blacklists</p>
            <p className="desc tp8">Ensure sensitive information never makes its way to your clipboard by excluding certain sources.</p>
          </span>
        </artice>
        <article className="feature">
          ...
          <span className="desc">
            <p className="title tp6">Plain text snippets</p>
            <p className="desc tp8">Remove unwanted formatting from copied text for a consistent look.</p>
          </span>
        </article>
        <article className="feature">
          ...
          <span className="desc">
            <p className="title tp6">Sneak preview</p>
            <p className="desc tp8">Quick preview of all snippets on your Clipboard for easy access.</p>
          </span>
        </article>
      </article>
    </section>
    <section className="logos-cont">
      <span className="logo-grp _1">
        <img src={googleLogo} alt="google logo" />
        <img src={ibmLogo} alt="ibm logo" />
        <img src={msLogo} alt="microsoft logo" />
      </span>
      <span className="logo-grp _2">
        <img src={hpLogo} alt="HP logo" />
        <img src={vgLogo} alt="vector graphics" />
      </span>
    </section>
    <section className="clip-cont">
      <article className="text-cont">
        <p className="title tp5">Clipboard for iOS and Mac OS</p>
        <p className="desc tp8">Available for free on the App Store. Download for Mac or iOS, sync with iCloud and you’re ready to start adding to your clipboard.</p>
      </article>
